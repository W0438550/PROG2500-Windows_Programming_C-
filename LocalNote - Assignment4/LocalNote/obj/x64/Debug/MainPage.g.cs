...
namespace LocalNote
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
        ...
        private class MainPage_obj4_Bindings :
            ...
            IMainPage_Bindings
        {
            private global::LocalNote.Models.NoteFile dataRoot;
            ...
            public void ProcessBindings(global::System.Object item, int itemIndex, int phase, out int nextPhase)
            {
                ...
                this.Update_((global::LocalNote.Models.NoteFile) item, 1 << phase);
            }
            ...
            public bool SetDataRoot(global::System.Object newDataRoot)
            {
                if (newDataRoot != null)
                {
                    this.dataRoot = (global::LocalNote.Models.NoteFile)newDataRoot;
                    return true;
                }
                return false;
            }
            ...
            private void Update_(global::LocalNote.Models.NoteFile obj, int phase)
            {
                if (obj != null)
                {
            ...
            IMainPage_Bindings
        {
            ...
            private void Update_NFViewModel(global::LocalNote.ViewModels.NoteFileViewModel obj, int phase)
            {
                ...
                if (obj != null)
                {
                    ...
                    if ((phase & (NOT_PHASED | DATA_CHANGED | (1 << 0))) != 0)
                    {
                        ...
                        this.Update_NFViewModel_FileName(obj.FileName, phase);
                        this.Update_NFViewModel_FileText(obj.FileText, phase);
                        this.Update_NFViewModel_SelectedFile(obj.SelectedFile, phase);
                    }
                }
            }
            private void Update_NFViewModel_NoteFiles(global::System.Collections.ObjectModel.ObservableCollection<global::LocalNote.Models.NoteFile> obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_NFViewModel_ExitCommand(global::LocalNote.Commands.ExitCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_NFViewModel_AddCommand(global::LocalNote.Commands.AddCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_NFViewModel_SaveCommand(global::LocalNote.Commands.SaveCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_NFViewModel_EditCommand(global::LocalNote.Commands.EditCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_NFViewModel_DeleteCommand(global::LocalNote.Commands.DeleteCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void Update_NFViewModel_FileName(global::System.String obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void Update_NFViewModel_SelectedFile(global::LocalNote.Models.NoteFile obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED | DATA_CHANGED)) != 0)
                {
            ...
            private void UpdateTwoWay_14_Text()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NFViewModel != null)
                        {
                            this.dataRoot.NFViewModel.FileText = this.obj14.Text;
                        }
                    }
                }
            }
            private void UpdateTwoWay_15_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NFViewModel != null)
                        {
                            this.dataRoot.NFViewModel.SelectedFile = (global::LocalNote.Models.NoteFile)this.obj15.SelectedItem;
                        }
                    }
                }
            }
            ...
            private class MainPage_obj1_BindingsTracking
            {
                ...
                public void PropertyChanged_NFViewModel(object sender, global::System.ComponentModel.PropertyChangedEventArgs e)
                {
                    ...
                    if (bindings != null)
                    {
                        ...
                        global::LocalNote.ViewModels.NoteFileViewModel obj = sender as global::LocalNote.ViewModels.NoteFileViewModel;
                        if (global::System.String.IsNullOrEmpty(propName))
                        {
                            if (obj != null)
                            {
                                bindings.Update_NFViewModel_Filter(obj.Filter, DATA_CHANGED);
                                bindings.Update_NFViewModel_FileName(obj.FileName, DATA_CHANGED);
                ...
                private global::LocalNote.ViewModels.NoteFileViewModel cache_NFViewModel = null;
                public void UpdateChildListeners_NFViewModel(global::LocalNote.ViewModels.NoteFileViewModel obj)
                {

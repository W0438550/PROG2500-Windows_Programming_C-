#pragma checksum "D:\NSCC\Course_Work\Year2Sem2\PROG2500-Windows_Programming_C#\Assignments\LocalNote - Copy\LocalNote\MainPage.xaml" "{406ea660-64cf-4c82-b6f0-42d48172a799}" "D4B117F46D5D57CEF04415D10AEB370D"
//------------------------------------------------------------------------------
// <auto-generated>
...
namespace LocalNote
{
        ...
        global::Windows.UI.Xaml.Markup.IComponentConnector2
    {
            ...
            IMainPage_Bindings
        {
            ...
            private void Update_NFViewModel_AboutCommand(global::LocalNote.Commands.AboutCommand obj, int phase)
            {
                if ((phase & ((1 << 0) | NOT_PHASED )) != 0)
                {
            ...
            private void UpdateTwoWay_14_SelectedItem()
            {
                if (this.initialized)
                {
                    if (this.dataRoot != null)
                    {
                        if (this.dataRoot.NFViewModel != null)
                        {
                            this.dataRoot.NFViewModel.SelectedFile = (global::LocalNote.Models.NoteFile)this.obj14.SelectedItem;
                        }
                    }
                }
            }

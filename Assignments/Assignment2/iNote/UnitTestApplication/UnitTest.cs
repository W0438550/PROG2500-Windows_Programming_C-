...
namespace UnitTestApplication
{
    ...
    {
        // Assignment 4 - SQLite Unit Testing
        [TestMethod]
        ...
        // test method to check if a file name has been correctly created
        [TestMethod]
        ...
        // test method to check if a file content has been created
        [TestMethod]
        ...
        // test method to check if a file content has been accurately created
        [TestMethod]
        ...
        // Assignment 3 - Local file Unit Testing
        ...
        //    iNoteRepo.CreateNewFile(fileName, text);
        ...
        //    iNoteRepo.WriteToFile(text, newFile);
        ...
        //    iNoteRepo.CreateNewFile(newFile, fileContent);

        //    iNoteRepo.DeleteFile(newFile);
        ...
        //    iNoteRepo.CreateNewFile(newFile, text);
